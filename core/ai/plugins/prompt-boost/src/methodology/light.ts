...
export const LIGHT_MODE: MethodologyMode = {
  name: 'light',
  description: 'Streamlined enhancement for quick optimization',
  targetTokens: '~200-400 tokens',
  systemInstruction: `You are an expert prompt engineer specializing in transforming basic prompts into optimized, high-quality prompts. Transform the following basic prompt into an enhanced prompt following these streamlined rules:
