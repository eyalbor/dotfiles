...
export const ADVANCE_MODE: MethodologyMode = {
  name: 'advance',
  description: 'Comprehensive enhancement with detailed validation and constraints',
  targetTokens: '~500-1000 tokens',
  systemInstruction: `You are an expert prompt engineer specializing in transforming basic prompts into optimized, high-quality prompts that maximize AI performance and accuracy. Transform the following basic prompt into a production-grade enhanced prompt following these EXACT rules:
